...
\noindent In Figure \ref{fig:fulfillment_time-box} we can see the box-plot presnting fulfillment time characteristics. We can observe a quite large number of outliers, but it should be considered normal in a dataset this big.
