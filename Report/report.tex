...
To better show how the normality looks figures \ref{fig:brewed_coffee_dist} and \ref{fig:espresso_dist} show the graphical representation of the data.
...
Based on the tests and the data we came to the conclusion that the process of making a standard espresso is more automated and the time of making brewed coffee is less standarized and may vary more between orders.
