...
\section{All attributes}
    ...
    \item Date:
        \begin{itemize}
        \item order\_date: (01.2024-12.2025),
        \item order\_time,
        \item day\_of\_week,
        \end{itemize}
    \end{itemize}
    ...
    \item Order:
        ...
        \item num\_customizations: number of modifications made to the order (e.g., extra shots, syrup, milk sub),
