...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=0.5\textwidth]{../Resources/Charts/order_channel_pie_chart.pdf}
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=0.5\textwidth]{../Resources/Charts/num_customizations_histogram.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{../Resources/Charts/box-plots/total_spend-box.pdf}
...
\noindent In Figure \ref{fig:fulfillment_time-box} we can see the box-plot presenting fulfillment time characteristics.



\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{../Resources/Charts/box-plots/fulfillemnt_time_min-box.pdf}
